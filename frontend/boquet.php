...
<main class="container mt-5">
    <section id="products" class="mt-5">
        ...
        <div class="row">
            <div class="col-md-4">
                <img src="https://imgcdn.floweraura.com/a-floral-dance-of-grace-and-prosperity-9806010flm-A_3.jpg?tr=w-264,dpr-1.5,q-70" alt="Flower Arrangement 1" class="img-fluid flower-image">
                <h4>Red rosses</h4>
                <p>Rs:800</p>
                <a href="order_form.php">Add to Cart</a>
            </div>
            <div class="col-md-4">
                <img src="https://imgcdn.floweraura.com/floral-symphony-in-golden-vase-9813250flm-A_0.jpg?tr=w-264,dpr-1.5,q-70" alt="Flower Arrangement 2" class="img-fluid flower-image">
                <h4>Pink feels cute</h4>
                <p>Rs:500</p>
                <a href="order_form.php">Add to Cart</a>
            </div>
            <div class="col-md-4">
                <img src="https://imgcdn.floweraura.com/beautiful-blossoms-medley-9802430fl-A_0.jpg?tr=w-264,dpr-1.5,q-70" alt="Flower Arrangement 3" class="img-fluid flower-image">
                <h4>joy full bloom</h4>
                <p>Rs:700</p>
                <a href="order_form.php">Add to Cart</a>
            </div>    
            <div class="col-md-4">
                <img src="https://imgcdn.floweraura.com/canvas-of-subtle-grace-9801680flm-A_0.jpg?tr=w-264,dpr-1.5,q-70" alt="Flower Arrangement 4" class="img-fluid flower-image">
                <h4>wild flower creation</h4>
                <p>Rs:900</p>
                <a href="order_form.php">Add to Cart</a>
            </div>
            <div class="col-md-4">
                <img src="https://imgcdn.floweraura.com/lily-dreamland-with-purple-daisy-9781960fl-A.jpg?tr=w-264,dpr-1.5,q-70" alt="Flower Arrangement 5" class="img-fluid flower-image">
                <h4>petal play</h4>
                <p>Rs:750</p>
                <a href="order_form.php">Add to Cart</a>
            </div> 
            <div class="col-md-4">
                <img src="https://imgcdn.floweraura.com/whispering-lilies-in-a-wine-red-dream-9781820fl-A.jpg?tr=w-264,dpr-1.5,q-70" alt="Flower Arrangement 5" class="img-fluid flower-image">
                <h4>fantasy</h4>
                <p>Rs:850</p>
                <a href="order_form.php">Add to Cart</a>
            </div> 

...
<a href="http://localhost/WAD/luxury_flower.php"><span class="tag-cloud">luxury flowers</span>
...
<main class="container mt-5">
    ...
    <section id="products" class="mt-5">
        ...
        <div class="row">
            <div class="col-md-4">
                <img src="https://imgcdn.floweraura.com/birthday-wishes-and-rose-fusion-9800420fl-A.jpg?tr=w-264,dpr-1.5,q-70" alt="Flower Arrangement 1" class="img-fluid flower-image">
                <h4>Birthday Wishes And Rose Fusion</h4>
                <p>Rs:800</p>
                <a href="order_form.php">Add to Cart</a>
            </div>
            <div class="col-md-4">
                <img src="https://imgcdn.floweraura.com/rosey-birthday-wish-9781130fl-A.jpg?tr=w-264,dpr-1.5,q-70" alt="Flower Arrangement 2" class="img-fluid flower-image">
                <h4>Rosey Birthday Wish</h4>
                <p>Rs:500</p>
                <a href="order_form.php">Add to Cart</a>
            </div>
            <div class="col-md-4">
                <img src="https://imgcdn.floweraura.com/charming-gerbera-carnation-bouquet-9796010fl-A_0.jpg?tr=w-264,dpr-1.5,q-70" alt="Flower Arrangement 3" class="img-fluid flower-image">
                <h4>Charming Gerbera Carnation Bouquet</h4>
                <p>Rs:700</p>
                <a href="order_form.php">Add to Cart</a>
            </div>    
            <div class="col-md-4">
                <img src="https://imgcdn.floweraura.com/birthday-celebration-pink-roses-9801130fl-A.jpg?tr=w-264,dpr-1.5,q-70" alt="Flower Arrangement 4" class="img-fluid flower-image">
                <h4>Birthday Celebration Pink Roses</h4>
                <p>Rs:900</p>
                <a href="order_form.php">Add to Cart</a>
            </div>
            <div class="col-md-4">
                <img src="https://imgcdn.floweraura.com/love-blooms-with-best-wishes-9802740fl-A_0.jpg?tr=w-264,dpr-1.5,q-70" alt="Flower Arrangement 5" class="img-fluid flower-image">
                <h4>Love Blooms With Best Wishes</h4>
                <p>Rs:750</p>
                <a href="order_form.php">Add to Cart</a>
            </div> 
            <div class="col-md-4">
                <img src="https://imgcdn.floweraura.com/ultimate-rose-box-9905600fl-A%20(2).jpg?tr=w-264,dpr-1.5,q-70" alt="Flower Arrangement 5" class="img-fluid flower-image">
                <h4>Ultimate Rose Box</h4>
                <p>Rs:850</p>
                <a href="order_form.php">Add to Cart</a>
            </div> 
        </div>

...
<main class="container mt-5">
    ...
    <section id="products" class="mt-5">
        ...
        <div class="row">
            <div class="col-md-4">
                <img src="https://c3t6b9h6.rocketcdn.me/wp-content/uploads/2021/11/Rosepetal-and-Jasmine--300x300.jpg" alt="Flower Arrangement 1" class="img-fluid flower-image">
                <h4>Red rosses</h4>
                <p>Rs:800</p>
                <a href="order_form.php">Add to Cart</a>
            </div>
            <div class="col-md-4">
                <img src="https://c3t6b9h6.rocketcdn.me/wp-content/uploads/2021/11/Netted-Pink-Rose-Petals-300x300.png" alt="Flower Arrangement 2" class="img-fluid flower-image">
                <h4>Pink feels cute</h4>
                <p>Rs:500</p>
                <a href="order_form.php">Add to Cart</a>
            </div>
            <div class="col-md-4">
                <img src="https://c3t6b9h6.rocketcdn.me/wp-content/uploads/2021/11/Pink-and-Redrose-Garland-300x300.jpg" alt="Flower Arrangement 3" class="img-fluid flower-image">
                <h4>joy full bloom</h4>
                <p>Rs:700</p>
                <a href="order_form.php">Add to Cart</a>
            </div>    
            <div class="col-md-4">
                <img src="https://c3t6b9h6.rocketcdn.me/wp-content/uploads/2024/02/Pink-Rose-Bud-Gypsy-Garland-1-300x300.jpg" alt="Flower Arrangement 4" class="img-fluid flower-image">
                <h4>wild flower creation</h4>
                <p>Rs:900</p>
                <a href="order_form.php">Add to Cart</a>
            </div>
            <div class="col-md-4">
                <img src="https://c3t6b9h6.rocketcdn.me/wp-content/uploads/2021/11/Red-Pink-Rose-Petal-300x300.jpeg" alt="Flower Arrangement 5" class="img-fluid flower-image">
                <h4>petal play</h4>
                <p>Rs:750</p>
                <a href="order_form.php">Add to Cart</a>
            </div> 
            <div class="col-md-4">
                <img src="https://c3t6b9h6.rocketcdn.me/wp-content/uploads/2023/03/WhatsApp-Image-2023-03-17-at-16.35.04-300x300.jpeg" alt="Flower Arrangement 5" class="img-fluid flower-image">
                <h4>fantasy</h4>
                <p>Rs:850</p>
                <a href="order_form.php">Add to Cart</a>
            </div> 

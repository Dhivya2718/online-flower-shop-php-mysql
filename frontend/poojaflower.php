...
<main class="container mt-5">
    ...
    <section id="products" class="mt-5">
        ...
        <div class="row">
            <div class="col-md-4">
                <img src="https://c3t6b9h6.rocketcdn.me/wp-content/uploads/2021/11/Areca-catechu-flower-1-300x300.jpg" alt="Flower Arrangement 1" class="img-fluid flower-image">
                <h4>Red rosses</h4>
                <p>Rs:800</p>
                <a href="order_form.php">Add to Cart</a>
            </div>
            <div class="col-md-4">
                <img src="https://c3t6b9h6.rocketcdn.me/wp-content/uploads/2021/10/garl-300x300.jpg" alt="Flower Arrangement 2" class="img-fluid flower-image">
                <h4>Pink feels cute</h4>
                <p>Rs:500</p>
                <a href="order_form.php">Add to Cart</a>
            </div>
            <div class="col-md-4">
                <img src="https://c3t6b9h6.rocketcdn.me/wp-content/uploads/2021/10/purple-aster-300x300.jpg" alt="Flower Arrangement 3" class="img-fluid flower-image">
                <h4>joy full bloom</h4>
                <p>Rs:700</p>
                <a href="order_form.php">Add to Cart</a>
            </div>    
            <div class="col-md-4">
                <img src="https://c3t6b9h6.rocketcdn.me/wp-content/uploads/2021/12/coconut-leaf-rhoranam-3-300x300.jpg" alt="Flower Arrangement 4" class="img-fluid flower-image">
                <h4>wild flower creation</h4>
                <p>Rs:900</p>
                <a href="order_form.php">Add to Cart</a>
            </div>
            <div class="col-md-4">
                <img src="https://c3t6b9h6.rocketcdn.me/wp-content/uploads/2021/10/Davanam-Leaf-300x270.jpg" alt="Flower Arrangement 5" class="img-fluid flower-image">
                <h4>petal play</h4>
                <p>Rs:750</p>
                <a href="order_form.php">Add to Cart</a>
            </div> 
            <div class="col-md-4">
                <img src="https://c3t6b9h6.rocketcdn.me/wp-content/uploads/2023/09/Temple-Garland-Durva-Grass-Garland-2ft-300x300.png" alt="Flower Arrangement 5" class="img-fluid flower-image">
                <h4>fantasy</h4>
                <p>Rs:850</p>
                <a href="order_form.php">Add to Cart</a>
            </div> 
